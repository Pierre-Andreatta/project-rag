...
from rag_project.adapters.embedding_adapter import EmbeddingAdapter, SentenceTransformerEmbeddingAdapter
from rag_project.adapters.llm_adapter import LLMAdapter, OpenAILLMAdapter
...
class RagService:
    ...
    @staticmethod
    def _enrich_with_sources(documents: List[DocumentDto], source_crud: SourceCRUD) -> List[SourceDto]:
        ...
        try:
            ...
            for source_id in source_ids:
                source = source_crud.get_source_by_id(source_id)
                if source:
    ...
    def search_similar_documents(
        ...
        try:
            ...
            documents = content_crud.find_similar_contents(
            ...
            sources = self._enrich_with_sources(documents, source_crud)
